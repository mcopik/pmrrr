...
int odrre_(char *range, int *n, FloatingType *vl, 
...
//	    FloatingType *, FloatingType *, FloatingType *, int *);
    FloatingType usedqd; //TODO long FloatingType
